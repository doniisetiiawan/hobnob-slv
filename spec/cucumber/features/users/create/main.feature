Feature: Create User
  ...
  Scenario Outline: Invalid Profile
    ...
    Examples:
      ...
      | payload                                                                               | message                                                   |
      | {"email":"e@ma.il","password":"password","profile":{"foo":"bar"}}                     | The '.profile' object does not support the field 'foo'    |
      | {"email":"e@ma.il","password":"password","profile":{"name":"Jane Doe"}}               | The '.profile.name' field must be of type object          |
      | {"email":"e@ma.il","password":"password","profile":{"name":{"first":"Jane","a":"b"}}} | The '.profile.name' object does not support the field 'a' |
      | {"email":"e@ma.il","password":"password","profile":{"summary":0}}                     | The '.profile.summary' field must be of type string       |
      | {"email":"e@ma.il","password":"password","profile":{"bio":0}}                         | The '.profile.bio' field must be of type string           |
