...
describe('Engine - User - Delete', () => {
  describe('When invoked', () => {
    before(function () {
      this.ESClientDeleteStub = generateESClientDeleteStub.failure();
      this.revert = del.__set__('client', {
        delete: this.ESClientDeleteStub,
      });
      return del(req)
        .then((res) => {
          this.result = res;
  ...
  describe('When the client.delete operation is successful', () => {
    beforeEach(function () {
  ...
  describe('When the client.delete operation is unsuccessful', () => {
    describe('Because the user does not exists', () => {
      beforeEach(function () {
    ...
    describe('Because of other errors', () => {
      beforeEach(function () {
        this.ESClientDeleteStub = generateESClientDeleteStub.failure();
        this.revert = del.__set__('client', {
          delete: this.ESClientDeleteStub,
