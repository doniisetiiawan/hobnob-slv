...
describe('Engine - User - Retrieve', () => {
  describe('When invoked', () => {
    before(function () {
      ...
      this.revert = retrieve.__set__('client', {
        get: this.ESClientGetStub,
      });
      return retrieve(req)
        .then((res) => {
          this.result = res;
  ...
  describe('When the client.get operation is successful', () => {
    beforeEach(function () {
  ...
  describe('When the client.get operation is unsuccessful', () => {
