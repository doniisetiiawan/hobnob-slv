...
describe('Handler - Users - Search', () => {
  ...
  describe('When searchUser throws an unexpected error', () => {
    before(function () {
      const req = {};
      this.res = generateResSpy();
      const searchUserStubs = generateSearchUserStubs();
      this.revert = search.__set__(
        'searchUser',
        searchUserStubs.genericError,
      );
      return search(req, this.res)
        .then((res) => {
          this.result = res;
