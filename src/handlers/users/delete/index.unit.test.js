...
describe('Handler - Users - Delete', () => {
  ...
  describe('When the user cannot be found', () => {
    before(function () {
      ...
      this.res = generateResSpy();
      const deleteUserStubs = generateDeleteUserStubs();
      this.revert = del.__set__(
        'deleteUser',
        deleteUserStubs.notFoundError,
      );
      return del(req, this.res)
        .then((res) => {
          this.result = res;
  ...
  describe('When deleteUser throws an unexpected error', () => {
    before(function () {
      const req = {};
      this.res = generateResSpy();
      const deleteUserStubs = generateDeleteUserStubs();
