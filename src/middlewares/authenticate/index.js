...
function authenticate(req, res, next) {
  ...
  // Apart from the above endpoints, the client must provide
  // an Authorization header, otherwise we should respond with a 401 Unauthorized
  ...
  jwt.verify(
    ...
    (err, decodedToken) => {
      ...
      req.user = { ...req.user, id: decodedToken.sub };
      next();
    },
  );
}
